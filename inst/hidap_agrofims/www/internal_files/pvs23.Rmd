...
```{r echo = FALSE}
check <- st4gi::check.rcbd("MSM", "INSTN", "REP", data)
...
```{r echo = FALSE}
check <- st4gi::check.rcbd("MSWM", "INSTN", "REP", data)
if (max(check$tfreq) > 0 & check$c4 == 1) {
...
```{r echo = FALSE}
check <- st4gi::check.rcbd("MSGLO", "INSTN", "REP", data)
if (max(check$tfreq) > 0 & check$c4 == 1) {
...
```{r echo = FALSE}
check <- st4gi::check.rcbd("BSM", "INSTN", "REP", data)
if (max(check$tfreq) > 0 & check$c4 == 1) {
...
```{r echo = FALSE}
check <- st4gi::check.rcbd("BSWM", "INSTN", "REP", data)
if (max(check$tfreq) > 0 & check$c4 == 1) {
...
```{r echo = FALSE}
check <- st4gi::check.rcbd("BSGLO", "INSTN", "REP", data)
if (max(check$tfreq) > 0 & check$c4 == 1) {
